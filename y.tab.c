...
{
       0,    95,    95,   128,    94,   166,   170,   179,   185,   201,
     204,   208,   215,   219,   225,   226,   229,   247,   246,   262,
     261,   278,   282,   288,   310,   340,   348,   352,   358,   362,
     372,   373,   375,   379,   386,   390,   398,   405,   419,   428,
     437,   445,   459,   471,   484,   488,   497,   503,   507,   516,
     520,   525,   534,   538,   547,   553,   572,   586,   592,   598,
     602,   610
};
#endif
...
#line 186 "wumbo.y" /* yacc.c:1646  */
    {
		...
		while (list) {
			...
			sym_node_t *node = init_sym_node(list->id, PRIM_NODE, (yyvsp[-1].data_type), sym_table->scope->loc_offset);
			table_put(sym_table->scope, node);
			list = list->next;
		}
...
#line 1596 "y.tab.c" /* yacc.c:1646  */
  ...
  case 20:
#line 270 "wumbo.y" /* yacc.c:1646  */
    {
		sym_stack_t *tmp = stack_pop(&sym_table);
		proc_type_t *proc = init_proc_type((yyvsp[-1].data_type_list));
		sym_node_t *node = init_sym_node(strdup((yyvsp[-3].sval)), PROC_NODE, proc, 0);
		sym_table = stack_push(sym_table, tmp->scope, table_put(sym_table->scope, node));
	}
